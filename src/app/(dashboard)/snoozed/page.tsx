        ...
        <div className="flex-1 lg:w-[420px] lg:flex-initial flex flex-col gap-2 min-w-0">
          ...
          {isLoading && page === 1 ? (
            ...
            <div className="p-12 text-center border border-dashed border-border-subtle rounded-2xl flex flex-col items-center justify-center bg-surface/20">
              <div className="h-12 w-12 rounded-2xl bg-surface-elevated text-blue-400 flex items-center justify-center mb-3">
            ...
            <div className="space-y-2">
              {allFetchedEmails.map((email) => (
                <EmailListItem
                  ...
                  onSnooze={(id) => {
                    // Clicking snooze on an already snoozed item in this list unsnoozes it back to inbox
                    snoozeMutation.mutate({ id, isSnoozed: false });
                  }}
        ...
        <div className="hidden lg:flex flex-1 bg-surface rounded-2xl border border-border-subtle p-6 flex-col justify-between overflow-y-auto shadow-sm min-h-[600px]">
          {selectedEmail ? (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-surface-elevated hover:bg-surface-overlay text-xs text-blue-400 hover:text-blue-300 transition-colors border border-white/5 flex items-center gap-1.5"
            ...
            <div className="flex flex-col items-center justify-center h-full text-text-muted text-sm font-ui gap-2">
              <div className="w-12 h-12 rounded-full bg-surface-elevated flex items-center justify-center text-blue-400">
